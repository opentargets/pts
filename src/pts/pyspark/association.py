...
def association(
    ...
    association_by_datatype = Evidence.from_raw_evidence(raw_evidence).aggregate_evidence_by_datasource(persist=True)

    # Save direct association by datasource:
    logger.info('Processing direct association stratified by datasource.')
    (
        association_by_datatype.compute_novelty(
    ...
    (
        association_by_datatype.aggregate_overall(datasource_weights)
        .compute_novelty(
            novelty_scale=novelty_scale,
            novelty_shift=novelty_shift,
            novelty_window=novelty_window,
    ...
    (
        association_by_datatype.aggregate_by_datatype(datasource_weights)
        .compute_novelty(
            novelty_scale=novelty_scale,
            novelty_shift=novelty_shift,
            novelty_window=novelty_window,
    ...
    association_by_datatype.df.unpersist()
